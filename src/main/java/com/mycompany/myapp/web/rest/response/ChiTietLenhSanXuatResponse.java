...
public class ChiTietLenhSanXuatResponse {
    private Long id;
    ...
    public ChiTietLenhSanXuatResponse() {
    }

    public ChiTietLenhSanXuatResponse(Long id, Integer reelID, String partNumber, String vendor, String lot, String userData1, String userData2, String userData3, Integer userData4, Integer userData5, Integer initialQuantity, String msdLevel, String msdInitialFloorTime, String msdBagSealDate, String marketUsage, Integer quantityOverride, String shelfTime, String spMaterialName, String warningLimit, String maximumLimit, String comments, ZonedDateTime warmupTime, String storageUnit, String subStorageUnit, String locationOverride, String expirationDate, String manufacturingDate, String partClass, Integer sapCode, String trangThai, Integer checked) {
        this.id = id;
        this.reelID = reelID;
