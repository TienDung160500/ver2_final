...
public class UserController {
    ...
    public String putThongSo(@PathVariable String maThongSo, @RequestBody QuanLyThongSoRequest request) {
    ...
    public KichBanResponse getKichBanById(@PathVariable Long id) {
        KichBanResponse response = this.userServices.getKichBanById(id);
        return response;
    }
    ...
    @GetMapping("/chi-tiet-san-xuat/{maKichBan}")
    public List<ChiTietSanXuatResponse> getChiTietSanXuatByMaKichBan(@PathVariable String maKichBan) {
        List<ChiTietSanXuatResponse> responseList = this.userServices.getChiTietSanXuatByMaKichBan(maKichBan);
        System.out.println("líst:   " + responseList.toString());
        return responseList;
    }
