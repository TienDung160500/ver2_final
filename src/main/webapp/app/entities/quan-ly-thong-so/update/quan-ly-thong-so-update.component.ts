...
export class QuanLyThongSoUpdateComponent implements OnInit {
  ...
  protected createFromForm(): IQuanLyThongSo {
    // const ngayTaoValue = this.editForm.get(['ngayTao'])!.value;
    // const ngayUpdateValue = this.editForm.get(['ngayUpdate'])!.value;

    // const parseDateFn = (dateString: string | undefined | null): Dayjs | null => {
    //   if (dateString) {
    ...
    // const ngayTaoParsed = parseDateFn(ngayTaoValue);
    // const ngayUpdateParsed = parseDateFn(ngayUpdateValue);
